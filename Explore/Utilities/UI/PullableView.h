...
typedef enum PullableState{
    PullableStateOpened,
    PullableStateHalfOpened,
    PullableStateClosed
}PullableState;
@class PullableView;
...
@interface PullableView : UIView {
    ...
    PullableState state;
    BOOL isAnchoringEnabled;
//    id<PullableViewDelegate> delegate;
}

@property (nonatomic, assign)BOOL isAnchoringEnabled;
...
@property (nonatomic, readwrite, assign) CGPoint anchoredCenter;
...
@property (readonly, assign) PullableState state;
